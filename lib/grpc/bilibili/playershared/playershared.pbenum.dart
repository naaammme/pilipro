...
class ArcType extends $pb.ProtobufEnum {
  static const ArcType ArcType_UNKNOWN_DEFAULT =
      ArcType._(0, _omitEnumNames ? '' : 'ArcType_UNKNOWN_DEFAULT');
...
class BizType extends $pb.ProtobufEnum {
  static const BizType BizType_UNKNOWN_DEFAULT =
      BizType._(0, _omitEnumNames ? '' : 'BizType_UNKNOWN_DEFAULT');
...
class CodeType extends $pb.ProtobufEnum {
  static const CodeType CodeType_UNKNOWN_DEFAULT =
      CodeType._(0, _omitEnumNames ? '' : 'CodeType_UNKNOWN_DEFAULT');
...
class FoldStyle extends $pb.ProtobufEnum {
  static const FoldStyle FoldStyle_UNKNOWN_DEFAULT =
      FoldStyle._(0, _omitEnumNames ? '' : 'FoldStyle_UNKNOWN_DEFAULT');
...
class FragmentType extends $pb.ProtobufEnum {
  static const FragmentType FragmentType_UNKNOWN_DEFAULT =
      FragmentType._(0, _omitEnumNames ? '' : 'FragmentType_UNKNOWN_DEFAULT');
...
class QnPolicy extends $pb.ProtobufEnum {
  static const QnPolicy QnPolicy_UNKNOWN_DEFAULT =
      QnPolicy._(0, _omitEnumNames ? '' : 'QnPolicy_UNKNOWN_DEFAULT');
...
class ShowStyleType extends $pb.ProtobufEnum {
  static const ShowStyleType ShowStyleType_UNKNOWN_DEFAULT =
      ShowStyleType._(0, _omitEnumNames ? '' : 'ShowStyleType_UNKNOWN_DEFAULT');
...
class UnsupportScene extends $pb.ProtobufEnum {
  static const UnsupportScene UnsupportScene_UNKNOWN_DEFAULT = UnsupportScene._(
      0, _omitEnumNames ? '' : 'UnsupportScene_UNKNOWN_DEFAULT');
  ...
  static const $core.List<UnsupportScene> values = <UnsupportScene>[
    UnsupportScene_UNKNOWN_DEFAULT,
    PREMIERE,
  ];
